...
void DD_RAM_Address(uint8_t addr);
 ...
 uint8_t E[]={0xFF,0x99,0x99,0x99,0x81,0x00};// for reverse on padister fan clock wise print
 uint8_t I[]={0x81,0x81,0xFF,0xFF,0x81,0x81};// for reverse on padister fan clock wise print
 uint8_t D[]={0xFF,0x81,0x81,0x81,0x7E,0x00};// for reverse on padister fan clock wise print
 uint8_t M[]={0xFF,0x06,0x08,0x26,0xFF,0x00};// for reverse on padister fan clock wise print
 uint8_t U[]={0xFF,0x80,0x80,0x80,0xFF,0x00};// for reverse on padister fan clock wise print
 uint8_t K[]={0xFF,0x18,0x24,0x42,0x81,0x00};// for reverse on padister fan clock wise print
  uint8_t B[]={0xFF,0x91,0x91,0x91,0x7E,0x00};// for reverse on padister fan clock wise print
